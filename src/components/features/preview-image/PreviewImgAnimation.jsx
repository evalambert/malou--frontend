...
const PreviewImgAnimation = ({ medias = [] }) => {
    ...
    //         setHidePreview(true);
    //     }, 1010); // Délai de 0,5s avant d'afficher Swiper
    ...
    return (
        <>
            ...
            <div className={`fixed top-0 left-0 w-screen h-screen flex items-center justify-center !z-0 `}>
                <div className={` opacity-100 transition-all duration-350 w-[350px] h-[300px] border-2 border-violet-500`} style={{ animation: showPreview ? 'preview-img-animation 1s ease' : 'none' }}>

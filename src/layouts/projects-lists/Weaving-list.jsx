...
const WeavingList = ({
    ...
    useEffect(() => {
        ...
        const hiddenListHeightValue = document.querySelector(
            '.hidden-list-weaving'
        ).clientHeight;
        const hiddenListWidthValue = document.querySelector(
            '.hidden-list-weaving'
        ).clientWidth;
        ...
        liTitle.forEach((li) => {
            nextLiWidth = li.nextElementSibling
                ? li.nextElementSibling.offsetWidth
                : 0;

 ...
 */
    ...
    return (
        <>
            <div
                className={`poetry-wrapper-wrap absolute md:fixed top-0 md:top-[40px] left-0 z-[8] md:z-[999] h-screen max-md:pt-[20px] max-md:pl-[10px] ${className} ${isOnIndexPage ? 'pointer-events-auto w-[80px] cursor-pointer' : ''} ${!isOnPoetryPage && !isOnIndexPage ? 'pointer-events-none w-fit' : ''}`}
                onClick={
                    !isOnPoetryPage
                        ? () =>
